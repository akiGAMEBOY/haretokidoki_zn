...
|【有無】<br>|【コメント】<br>|【新規アプリ（winget search/show）】<br>　名前|<br>　ID|<br>　バージョン|<br>　ソース|【既存アプリ（winget list）】<br>　名前|<br>　ID|<br>　バージョン|<br>　利用可能|<br>　ソース|
|:---:|---|---|---|---|---|---|---|---|---|---|
...
下記は、ソース「`winget`」か「`msstore`」のアプリをインストールするコマンド。
...
```powershell:wingetアプリ（winget or msstore）をインストールした際のコマンド群
