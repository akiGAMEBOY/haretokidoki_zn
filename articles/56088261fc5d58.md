...
また、wingetではCLI（`winget upgrade`）で一括アップデートが可能。それとMicrosoft Store版のアプリとして導入する事により、[管理ソフト](https://www.microsoft.com/store/productId/9WZDNCRFJBMP?ocid=pdpshare)を使用しGUIでアップデートも可能です。
