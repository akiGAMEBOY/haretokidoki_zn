...
このような場合は、ウィンドウサイズを **横方向に広げて** Functionを実行すると、下記の通りすべて表示できます。

![](https://storage.googleapis.com/zenn-user-upload/6d2c4c22784b-20250501.png)

参考までにわたしの環境で実際に実行した結果は下記のとおり。
...
`Export-Csv` は、他にもエンコードの指定なども可能です。詳細は[こちら](https://learn.microsoft.com/ja-jp/powershell/module/microsoft.powershell.utility/export-csv)の公式ドキュメントをご確認ください。
