...
シモニイがハンガリー記法と呼ばれるものを使い始めたのは、それが多くの理由の内の一つだと、私は推測している。その記法はハンガリー語のように見え、シモニイはハンガリー出身だったので、この名前が付いた。シモニイ版のハンガリー記法では、すべての変数の頭に、その変数が含む種類を示す小文字のタグが付けられていた。
