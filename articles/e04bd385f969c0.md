...
間違ったコードを間違って見せることは良いことだが、必ずしも全てのセキュリティ問題に対する最適解ではない。起こりうる全てのバグやミスを見つけることはできない。でも、何もないよりあった方が良いのは確かで、間違ったコードが間違って見えるようなコーディング規約の方が良い。プログラマーがコードに目を通す度に、特定のバグがチェックされ未然に防ぐといったような増分的な利点が得られる。
