...
published: false
---
以前より元記事をご存じの方や再三に渡って議論してきた事と感じている方などは、何をいまさら英訳してるんだ。という感想になる方がいらっしゃると思いますが、
私は元記事やハンガリアン記法にシステムハンガリアンやアプリケーションハンガリアンがあったという事を最近、知りました。

頭にすんなり入ってくるような英訳の記事が見つからなかったので、自分なりに英訳し学習した結果を共有できればと思い記事として紹介します。
...
- 機械翻訳の使用 と 雰囲気で翻訳しています。
    基本的に機械翻訳（[DeepL翻訳](https://www.deepl.com/translator)）を使いニュアンスを汲み取り雰囲気で翻訳しているので、
