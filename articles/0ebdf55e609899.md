...
コマンドレットに、どのようなエイリアスが設定されているかを知りたい場合は、-Definition パラメータを使います。
