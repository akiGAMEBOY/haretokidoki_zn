...
:::details 表に変換したコマンド結果 - PowerShell 5.1（クリック・タップで折りたたみが開く）
...
:::details 表に変換したコマンド結果 - PowerShell 7.3.6（クリック・タップで折りたたみが開く）
...
:::details コマンド結果をMarkdownの表に変換した方法（クリック・タップで折りたたみが開く）
...
:::details PowerShellバージョン毎のエイリアス対応（クリック・タップで折りたたみが開く）
