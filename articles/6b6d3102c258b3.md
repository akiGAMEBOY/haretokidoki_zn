...
## KaTex公式のサポート表を参考に数式を含む表を作成

2024年4月現在、こちらの記事を参考に表を作成。

なお、KaTex公式の表の場合、数式が表示される項目「Rendered（レンダリング済み）」の欄に"Not Supported"があり、
パッと見わかりにくいと感じたため、この表では"Not Supported"を項目として外だししました。

`✓`となっている場合、KaTexではサポートされていない数式として"Not Suported"。
