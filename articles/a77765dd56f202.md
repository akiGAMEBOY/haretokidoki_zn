...
##### 入力ファイル
- XMLファイル
https://github.com/akiGAMEBOY/PowerShell_ShapingXMLfileTool/blob/master/source/powershell/setup.ini#L1-L1
##### 出力ファイル
- XMLファイル
https://github.com/akiGAMEBOY/PowerShell_ShapingXMLfileTool/blob/master/source/powershell/setup.ini#L1-L1
- XMLバックアップファイル
    整形前に対象XMLファイルをコピーする。コピー先は同じ階層にファイル名を変更し出力する。
### GitHub
https://github.com/akiGAMEBOY/PowerShell_ShapingXMLfileTool
#### フォルダ構成
```
...
- PowerShellのfunctionの戻り値制御は特殊
    想定する戻り値はSystem.Int32だったが、System.Object[]で返ってきた。
    この記事でわかる。
