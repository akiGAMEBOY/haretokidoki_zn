...
すべてコマンドで **不要なMicrosoft Edgeをアンインストール** して **Google Chromeのインストール** しちゃおう！
...
:::details はじめてだとこんなメッセージが表示されるかも

★なぜか失敗した。

```powershell
PS C:\Users\Administrator> winget search -q "microsoft edge"
...
Remote Tools for Microsoft Edge 9P6CMFV44ZLT                  Unknown       msstore
Microsoft Edge                  Microsoft.Edge                134.0.3124.72 winget
Microsoft Edge Beta             Microsoft.Edge.Beta           135.0.3179.18 winget
Microsoft Edge Canary           Microsoft.Edge.Canary         112.0.1705.0  winget
Microsoft Edge Dev              Microsoft.Edge.Dev            135.0.3179.11 winget
Microsoft Edge WebDriver        Microsoft.EdgeDriver          134.0.3124.68 winget
Microsoft Edge WebView2 Runtime Microsoft.EdgeWebView2Runtime 134.0.3124.72 winget
PS C:\Users\Administrator>
PS C:\Users\Administrator> winget uninstall --id "microsoft.edge"
