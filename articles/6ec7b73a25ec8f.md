...
“**管理者として実行**”でWindows PowerShellを起動した方がユーザーアカウント制御が表示されず処理を進めることができるのでオススメ。

[Windows PowerShellを管理者として実行する方法](https://zenn.dev/baker_link_lab/articles/2ea4260daf32e4)
...
下記のように引数を指定するとすべて自動で処理が進む。

```powerhsell:PowerShellのバージョン「7.5.0」を導入する場合
