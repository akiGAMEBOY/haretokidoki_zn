...
```powershell:PowerShell 5.1.xで確認
...
```powershell:PowerShell 7.3.xで確認
PS C:\Users\"ユーザー名"> $PROFILE | Format-List -Force
...
```powershell
PS C:\Users\"ユーザー名"> code D:\Downloads\20231113_memo.txt
PS C:\Users\"ユーザー名">
PS C:\Users\"ユーザー名"> & 'C:\Program Files (x86)\sakura\sakura.exe' D:\Downloads\20231113_memo.txt
```
...
https://laboradian.com/powershell-profile-path/
