...
:::details 参考情報：New-Itemコマンドレットを使った作成方（クリック・タップで折りたたみが開く）
...
:::details 参考情報：Set-Itemコマンドレットを使った変更方（クリック・タップで折りたたみが開く）
...
:::details 参考情報：PowerShell 5.1.xでプロファイルの種類や初期値を確（クリック・タップで折りたたみが開く）
...
:::details 補足情報：削除前後の環境変数一（クリック・タップで折りたたみが開く）
...
:::details 参考情報：コマンドレット「Remove-Item」や「Clear-Item」を使った削除方（クリック・タップで折りたたみが開く）
