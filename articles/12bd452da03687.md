...
:::details 参考情報：PowerShellのCLIでOfficeのバージョンを確認する方法（クリック・タップで折りたたみが開く）
...
:::details 実行時に動かない & VBAエディターでデバッグ時に警告（クリック・タップで折りたたみが開く）
...
::::details 参考情報：ショートカット一覧（クリック・タップで折りたたみが開く）
