...
1. セキュリティ センター → `セキュリティ センターの設定(T)...` をクリック
  ![](https://storage.googleapis.com/zenn-user-upload/3a5c2e97ae4c-20230718.png =800x)
1. マクロの設定 より 有効化
  `デジタル署名されたマクロに対しては警告を表示し、その他のマクロはすべて無効にする(S)`（デフォルト設定）から、
  `すべてのマクロを有効にする (推奨しません。危険なコードが実行される可能性があります)(N)` に変更。
  ![](https://storage.googleapis.com/zenn-user-upload/ddd4e9c698c1-20230718.png =800x)
  *画像：変更前*
  ![](https://storage.googleapis.com/zenn-user-upload/e44aa94149b6-20230718.png =800x)
  *画像：変更後*
...
- メイン画面での登録
  ...
  ![](https://storage.googleapis.com/zenn-user-upload/9b37aaa3d370-20230719.png =800x)
...
- 個別ウィンドウでの登録
  ...
  ![](https://storage.googleapis.com/zenn-user-upload/aea0573e8a9c-20230719.png =800x)
