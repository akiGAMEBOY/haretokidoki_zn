---
title: "“多次元配列（リテラル配列）”と“ジャグ配列”の要素数を取得する方法”"
emoji: "🐆"
...
[こちら](https://zenn.dev/haretokidoki/articles/1c671247e9523c)の記事でFunctionの引数に多次元配列（リテラル配列）の変数を使用しました。
...
- 多次元配列（リテラル配列） と ジャグ配列 で参考になった記事
