...
1. Write-EventLog
    ...
    - PowerShell 5.1以前
        ...
        ![Write-EventLog実行後にイベントビューアーを確認](https://storage.googleapis.com/zenn-user-upload/bc0e3cbda839-20240304.png)
    ...
    - PowerShell 6.0以降
        ...
        PS C:\Users\"ユーザー名"> New-WinEvent -ProviderName Microsoft-Windows-PowerShell -Id 45090  -Payload @("Write Event Message for PS6.0", "Infomation")
        PS C:\Users\"ユーザー名">
        ```
