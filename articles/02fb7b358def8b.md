...
![](https://storage.googleapis.com/zenn-user-upload/19c84154f034-20230512.png =800x)
...
1. DISKPARTを終了
    ...
    ```
1. 削除できた事を確認
    ![](https://storage.googleapis.com/zenn-user-upload/18b806cf9c2b-20230512.png =800x)
