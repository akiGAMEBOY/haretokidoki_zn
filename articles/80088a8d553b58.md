...
:::details その他 OSのサポート対象 <クリックで折りたたみが開く>
...
:::details なぜDNSの設定を行ったか <クリックで折りたたみが開く>
...
:::details 参考情報：設定後の/etc/ssh/sshd_config - すべて <クリックで折りたたみが開く>
...
:::details 参考情報：設定後の/etc/ntp.conf - すべて <クリックで折りたたみが開く>
...
1. FreeBSD セキュリティパッチのダウンロード
    ...
    :::details 参考情報：FreeBSD ダウンロード時のコマンド結果 - すべて <クリックで折りたたみが開く>
...
:::details 参考情報：インストール時のコマンド結果 - すべて <クリックで折りたたみが開く>
...
1. 最新のComposerをインストール
    ...
    **バージョンを指定してインストールする場合は、オプションを指定**
    ...
    :::details インストーラー「composer-setup.php」のヘルプ <クリックで折りたたみが開く>
...
1. インストールコマンドの実行
    ...
    **（私の環境では）インストールコマンドを実行時にエラーが発生**
    ...
    ::::details エラーへの対処方法 <クリックで折りたたみが開く>
    - 事象
    ...
    *画面: twitteroauthをComposer経由でインストールした際のエラー*
    ...
    - 対処方法
        ...
        1. `/usr/src/sys/amd64/conf/GENERIC` で IPv6の設定をコメントアウト
            ...
            :::details 参考情報：設定後の/usr/src/sys/amd64/conf/GENERIC - 全ぼう ※省略あり <クリックで折りたたみが開く>
        ...
        1. カーネルの再構築
            ...
            :::details 参考情報：“make cleandepend”コマンド結果 - 全ぼう ※省略あり <クリックで折りたたみが開く>
            ...
            :::
            :::details 参考情報：“make depend”コマンド結果 - 全ぼう ※省略あり <クリックで折りたたみが開く>
            ...
            :::
            :::details 参考情報：“make”コマンド結果 - 全ぼう ※省略あり <クリックで折りたたみが開く>
            ...
            :::
            :::details 参考情報：“make install”コマンド結果 - 全ぼう ※省略あり <クリックで折りたたみが開く>
