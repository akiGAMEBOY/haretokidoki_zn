...
1. 最近開いたもの一覧から“比較したいファイル”を選択
    ![最近開いたもの一覧から“比較したいファイル”を選択](https://storage.googleapis.com/zenn-user-upload/a25b21144da6-20240302.png)
    *画像：最近開いたもの一覧から比較対象のファイルを選択*
1. 比較モードが起動
    ![比較モードが起動](https://storage.googleapis.com/zenn-user-upload/88178959c058-20240302.png =500x)
    *画像：比較モードが起動*

    :::details 差分表示の方法を切り替えたい場合
...
:::details 補足情報：参考情報を元に私が作成したFunction「DiffTextfile」 < クリックで折りたたみが開く >
