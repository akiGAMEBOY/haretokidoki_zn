---
title: "Windows Update・Microsoft Defender・アプリを一括アップデートする方法"
emoji: "🗂"
...
まず自動更新をオフにしている環境において、アップデートする際に手作業で更新が必要。
...
Microsoft Store版のアプリも一括でアップデートする方法がないか調べましたが、見つけられませんでした。
...
- 下記を手動で一括アップデートしたい方
    ...
    - インストーラー版 アプリ（ソフトウェア）
        ※ 従来のMSI形式
        　 新しいMSIX形式のMicrosoft Store版 アプリは非対応
