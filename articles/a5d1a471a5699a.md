...
1. システムやアプリの手動アップデートを一括で行いたい場合に使用
    :::details 補足情報：システムやアプリを手動でアップデートしたい理由 < クリックで折りたたみが開く >
    なぜ自動更新機能をオンにしないのか。
...
1. インストーラー版アプリ は、Windowsのパッケージ管理システム「Windows Package Manager（winget）」を使用
    ...
    :::details メモ：Microsoft Store版アプリ（UWP）を対応させようとしたけどダメだった < クリックで折りたたみが開く >
...
:::details PowerShellの呼称 < クリックで折りたたみが開く >
...
:::details アンインストール < クリックで折りたたみが開く >
