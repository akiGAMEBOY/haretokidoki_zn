...
`Cannot convert the "System.Object[]" value of type "System.Object[]" to type "System.Int32".` このメッセージは、
Function（`New-Folder`）の戻り値は `System.Object[]` で返ってきたが 数値型の `$statusCode` に代入しようとしているため、
PowerShellでキャスト（型の変換）しようした結果、変換できずにエラーが発生した事がわかります。

### 戻り値System.Object[]の中身を確認すると……

では、実際の中身がどのようになっているかも確認してみましょう。
...
:::details System.Object[]の中身確認用のコード全体
