...
★現在、更新中★
ログインユーザーが`Administrator`でコマンドを実行している場合の結果を例とする。
| 取得できる内容 | 引数 | コマンド結果の例 |
| ---- | ---- | ---- |
...
| ユーザー Desktop | `shell:Desktop` | C:\Users\Administrator\Desktop |
| パブリック Documents | `shell:Common Documents` | C:\Users\Public\Documents |
| ユーザー Documents | `shell:Local Documents` | C:\Users\Administrator\Documents |
...
| パブリック Startup | `shell:Common Startup` | C:\ProgramData\Microsoft\Windows\Start Menu |
...
| ユーザー Downloads | `shell:Downloads` | C:\Users\Administrator\Downloads |
| パブリック Music | `shell:CommonMusic` | C:\Users\Public\Pictures |
...
| パブリック Video | `shell:CommonVideo` | C:\Users\Public\Music |
| ユーザー Video | `shell:Local Videos` or `shell:My Video` | C:\Users\Administrator\Music |
...
| ユーザー Music | shell:Local Music | C:\Users\Administrator\Music |
