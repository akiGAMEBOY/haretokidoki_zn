...
'*-------------------------------------------------------------------------------
'* 戻り値　｜-
'* 引数　　｜lngResultcode：対象メッセージコード, [任意]strAppend：追加メッセージ
'********************************************************************************
Sub SubShowMessagebox(lngResultcode As Long, Optional strAppend As String = "")
    Dim strMessage As String
    Dim lngCount As Long
    ...
    For lngCount = LBound(aryMessages, 1) To UBound(aryMessages, 1)
        If aryMessages(lngCount, 0) = CStr(lngResultcode) Then
    ...
    strMessage = strMessage & vbCrLf & "Message Code：" & "[" & CStr(lngResultcode) & "]"
