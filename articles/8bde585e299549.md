...
'*-------------------------------------------------------------------------------
'* 戻り値　｜-
'* 引数　　｜strPath：対象ファイルの絶対パス, strCsvrange：CSV開始セル位置,
'* 　　　　｜strSheetname：対象シート, strExcelrange：Excel開始セル位置,
'* 　　　　｜[任意]strCharcode：文字コード
'********************************************************************************
Sub SubLoadCsv(strPath As String, strCsvrange As String, _
...
Sub SubSaveCsv(strSheetname As String, strExcelrange As String, _
    ...
    Set rngSheet = Range(strExcelrange)
