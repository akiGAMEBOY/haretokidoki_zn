...
データ整形ツールとしての参考情報だけでなく、私個人で作成してみた自作モジュールの使い方や、
...
- 正規表現 - さまざまな正規表現
https://mom-neuroscience.com/vscode-regular-expression-replace/
- 正規表現 - マルチライン
https://qiita.com/birdwatcher/items/dee34a11619b11e1fe81

- Excel不具合 - コントロールをクリックするとフォントサイズが大きくなる
https://support.microsoft.com/ja-jp/topic/excel-でコントロールをクリックするとコントロールやフォントのサイズが変わる-db763c55-5a84-4277-893b-8a9cb98c41bd
...
- Excelで境界ダブルクリックではない方法で、高さを自動調整する方法
    https://forest.watch.impress.co.jp/docs/serial/exceltips/1079419.html
