...
日本語のWindows OSでPowerShellを使用する場合、PowerShellコンソール（PowerShellウィンドウ）の文字コードは規定値が複雑です。
...
## Windows OSにおけるPowerShellの文字コードの規定値
