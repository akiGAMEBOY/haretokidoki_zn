---
title: "[PowerShell]PSSessionを使いリモート接続してCLIを操作する方法"
emoji: "🎮"
...
---
## 概要
[こちら](https://zenn.dev/haretokidoki/articles/b742b44e45559b)の記事で自動変数「 `$PSSenderInfo` 」を調べた際、
PSSessionでリモート接続して確認しました。
