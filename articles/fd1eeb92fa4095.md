...
1. 接続元の設定 - PSRemothingの有効化
	上記と同様の「Enable-PSRemoting」コマンドを実行。
...
| [Export-PSSession](https://github.com/MicrosoftDocs/PowerShell-Docs/blob/main/reference/5.1/Microsoft.PowerShell.Utility/Export-PSSession.md) | x |
| [Import-PSSession](https://github.com/MicrosoftDocs/PowerShell-Docs/blob/main/reference/5.1/Microsoft.PowerShell.Utility/Import-PSSession.md) | x |
...
- Export-PSSession
    他のセッションのコマンド結果をPowerShellモジュールに保存する。
- Import-PSSession
